<x-guest-layout>
        ...
        <!-- site intro -->
        <div class="p-6 md:px-72 text-white md:pt-16 bg-blue-500 h-80 md:h-80 shadow-lg">
            ...
            <div class="flex ml-auto text-3xl place-self-center text-gray-100">
        ...
        <div class="md:grid md:grid-cols-4 gap-4 px-12 md:px-52 py-12 mx-auto">
            <div class="col-span-3 pb-12 md:p-0 md:pb-10 text-gray-600">
                <p class="text-4xl text-blue-500 font-bold">
                    TLDR; I create web apps and systems
                </p>
                <p class="text-2xl py-2">
                    I am full-stack web developer from Manila who's been working professionally for {{ date('Y') - 2018 }} 
                    years now. My skills ranges from
                     <span class="font-bold">web design and programming</span> to 
                     <span class="font-bold">SQL databases</span> and <span class="font-bold">system architecture</span>. 
                ...
                <p class="text-2xl py-2 text-gray-400">
                    ...
                    a lot of my free time lately.
                     I also do have an <a href="https://www.instagram.com/poltnine/" target="_blank" class="font-bold underline">instagram</a> and 
                     <a href="https://www.facebook.com/poltnine/" class="font-bold underline">fb page</a> 
