        ...
        <div className="px-5 py-4 border-b border-zinc-700/50 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img
              ...
              className="w-16 h-16 rounded-full object-cover border-2 border-indigo-400 cursor-pointer md:hover:scale-125 transition-transform duration-200"
            />
            <div>
      ...
      <AnimatePresence>
        {isModalOpen && (
          ...
          >
            ...
            <button
              onClick={() => setIsModalOpen(false)}
              className="absolute top-4 right-4 md:top-8 md:right-8 text-white hover:text-indigo-400 transition-colors z-50"
            >
            ...
            <motion.img
              ...
              className="max-w-[90vw] max-h-[80vh] md:max-w-[70vw] md:max-h-[85vh] rounded-2xl object-contain border-4 border-indigo-400 shadow-2xl"
            />
          </motion.div>
        )}
      </AnimatePresence>
